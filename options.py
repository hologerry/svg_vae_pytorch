...
def get_parser_image_vae():
    ...
    # experiment
    parser.add_argument('--batch_size', type=int, default=128, help='image vae batch_size')
...
def get_parser_svg_decoder():
    ...
    parser.add_argument('--vae_ckpt_path', type=str, default='experiments_00_47_lr001_image_vae/checkpoints/image_vae_180.pth')
